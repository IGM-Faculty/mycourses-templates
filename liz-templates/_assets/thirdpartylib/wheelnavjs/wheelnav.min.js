...
wheelnav.prototype.createWheel = function (n, t) {
   ...
   if (this.keynavigateEnabled) {
      var r = this
         , u = window;
      this.keynavigateOnlyFocus && (u = document.getElementById(this.holderId), u.hasAttribute("tabindex") || u.setAttribute("tabindex", 0));
      u.addEventListener("keydown", this.keyNavigateFunction = function (n) {
         var t, i;
         n = n || window.e;
         t = n.which || n.keyCode;
         [r.keynavigateDownCode, r.keynavigateDownCodeAlt, r.keynavigateUpCode, r.keynavigateUpCodeAlt].indexOf(n.keyCode) > -1 && n.preventDefault();
         i = null;
         (t === r.keynavigateUpCode || t === r.keynavigateUpCodeAlt) && (i = r.currentClick === r.navItemCount - 1 ? 0 : r.currentClick + 1);
         (t === r.keynavigateDownCode || t === r.keynavigateDownCodeAlt) && (i = r.currentClick === 0 ? r.navItemCount - 1 : r.currentClick - 1);
...
wheelnav.prototype.removeWheel = function () {
   if (this.raphael.remove(), this.keynavigateEnabled) {
      var n = window;
      this.keynavigateOnlyFocus && (n = document.getElementById(this.holderId), n.hasAttribute("tabindex") && n.removeAttribute("tabindex"));
      ...
      if (it = n.hasAttribute("data-wheelnav"), it) {
         ...
         for (c !== null && slicePath()[c] !== undefined && (this.slicePathFunction = slicePath()[c]), l = n.getAttribute("data-wheelnav-colors"), l !== null && (this.colors = l.split(",")), a = n.getAttribute("data-wheelnav-wheelradius"), a !== null && (this.wheelRadius = Number(a)), v = n.getAttribute("data-wheelnav-navangle"), v !== null && (this.navAngle = Number(v)), ut = n.getAttribute("data-wheelnav-rotateoff"), ut !== null && (this.clickModeRotate = !1), ft = n.getAttribute("data-wheelnav-cssmode"), ft !== null && (this.cssMode = !0), et = n.getAttribute("data-wheelnav-spreader"), et !== null && (this.spreaderEnable = !0), y = n.getAttribute("data-wheelnav-spreaderradius"), y !== null && (this.spreaderRadius = Number(y)), e = n.getAttribute("data-wheelnav-spreaderpath"), e !== null && markerPath()[e] !== undefined && (this.spreaderPathFunction = spreaderPath()[e]), ot = n.getAttribute("data-wheelnav-marker"), ot !== null && (this.markerEnable = !0), o = n.getAttribute("data-wheelnav-markerpath"), o !== null && markerPath()[o] !== undefined && (this.markerPathFunction = markerPath()[o]), p = n.getAttribute("data-wheelnav-titlewidth"), p !== null && (this.titleWidth = Number(p)), w = n.getAttribute("data-wheelnav-titleheight"), w !== null && (this.titleHeight = Number(w)), st = n.getAttribute("data-wheelnav-keynav"), st !== null && (this.keynavigateEnabled = !0), ht = n.getAttribute("data-wheelnav-keynavonlyfocus"), ht !== null && (this.keynavigateOnlyFocus = !0), b = n.getAttribute("data-wheelnav-keynavdowncode"), b !== null && (this.keynavigateDownCode = Number(b)), k = n.getAttribute("data-wheelnav-keynavdowncodealt"), k !== null && (this.keynavigateDownCodeAlt = Number(k)), d = n.getAttribute("data-wheelnav-keynavupcode"), d !== null && (this.keynavigateUpCode = Number(d)), g = n.getAttribute("data-wheelnav-keynavupcodealt"), g !== null && (this.keynavigateUpCodeAlt = Number(g)), ct = n.getAttribute("data-wheelnav-init"), ct !== null && (rt = !0), t = 0; t < n.children.length; t++) {
            ...
            if (nt !== null || r !== null || tt !== null) {
               ...
               for (n.children[t].onmouseup !== undefined ? f.push(n.children[t].onmouseup) : f.push(null), lt = !1, u = 0; u < n.children[t].children.length; u++) n.children[t].children[u].getAttribute("href") !== undefined && h.push(n.children[t].children[u].getAttribute("href"));
               lt || h.push(null)
            }
         }
         if (i.length > 0) {
...
wheelnavItem.prototype.createNavItem = function () {
   ...
   r = this.initNavTitle;
   this.navTitle = wheelnavTitle().isPathTitle(this.title) ? this.wheelnav.raphael.path(r.path) : wheelnavTitle().isImageTitle(this.title) ? this.wheelnav.raphael.image(r.src, t.titlePosX - this.titleWidth / 2, t.titlePosY - this.titleHeight / 2, this.titleWidth, this.titleHeight) : this.wheelnav.raphael.text(t.titlePosX, t.titlePosY, r.title);
...
wheelnavItem.prototype.setWheelSettings = function (n) {
   ...
   wheelnavTitle().isImageTitle(this.title) && (this.titleWidth === null && (this.titleWidth = 32), this.titleHeight === null && (this.titleHeight = 32));
   ...
   (this.animateeffect === null || n) && (this.animateeffect = this.wheelnav.animateeffect !== null ? this.wheelnav.animateeffect : "linear");
   (this.animatetime === null || n) && (this.animatetime = this.wheelnav.animatetime !== null ? this.wheelnav.animatetime : 1000);
...
wheelnavItem.prototype.initPathsAndTransforms = function () {
   ...
   this.sliceTransform = this.sliceTransformFunction !== null ? this.sliceTransformFunction(this.wheelnav.centerX, this.wheelnav.centerY, this.wheelnav.wheelRadius, this.baseAngle, this.sliceAngle, this.titleRotateAngle, this.itemIndex, this.sliceTransformCustom) : sliceTransform().NullTransform;
   this.selectTransform = this.sliceSelectedTransformFunction !== null ? this.sliceSelectedTransformFunction(this.wheelnav.centerX, this.wheelnav.centerY, this.wheelnav.wheelRadius, this.baseAngle, this.sliceAngle, this.titleRotateAngle, this.itemIndex, this.sliceSelectedTransformCustom) : sliceTransform().NullTransform;
   this.hoverTransform = this.sliceHoverTransformFunction !== null ? this.sliceHoverTransformFunction(this.wheelnav.centerX, this.wheelnav.centerY, this.wheelnav.wheelRadius, this.baseAngle, this.sliceAngle, this.titleRotateAngle, this.itemIndex, this.sliceHoverTransformCustom) : sliceTransform().NullTransform;
   this.initTransform = this.sliceInitTransformFunction !== null ? this.sliceInitTransformFunction(this.wheelnav.centerX, this.wheelnav.centerY, this.wheelnav.wheelRadius, this.baseAngle, this.sliceAngle, this.titleRotateAngle, this.itemIndex, this.sliceInitTransformCustom) : sliceTransform().NullTransform;
...
wheelnavItem.prototype.getTitleRotateString = function (n) {
   var t = "";
   return t += this.getItemRotateString(), t + (this.titleRotateAngle !== null && n ? ",r," + (this.navAngle + this.titleRotateAngle).toString() : ",r," + (-this.currentRotateAngle).toString())
};
...
slicePath = function () {
   return this.NullSlice = function (n, t, i) {
      ...
      return slicePathString = [n.MoveTo(n.middleAngle, i.startRadiusPercent * n.sliceRadius), n.LineTo(n.startAngle, r), n.ArcTo(u, n.middleAngle, r), n.ArcTo(u, n.endAngle, r), n.Close()], {
         slicePathString: slicePathString
         , linePathString: ""
         , titlePosX: n.titlePosX
         , titlePosY: n.titlePosY
      ...
      var n = new slicePathCustomization;
      return n.minRadiusPercent = .37, n.maxRadiusPercent = .9, n
   }, this.DonutSlice = function (n, t, i) {
      return i === null && (i = DonutSliceCustomization()), maxRadius = n.wheelRadius * t * i.maxRadiusPercent, minRadius = n.wheelRadius * t * i.minRadiusPercent, n.setBaseValue(t, i), n.titleRadius = (maxRadius + minRadius) / 2, n.setTitlePos(), slicePathString = [n.MoveTo(n.startAngle, minRadius), n.LineTo(n.startAngle, maxRadius), n.ArcTo(maxRadius, n.middleAngle, maxRadius), n.ArcTo(maxRadius, n.endAngle, maxRadius), n.LineTo(n.endAngle, minRadius), n.ArcBackTo(minRadius, n.middleAngle, minRadius), n.ArcBackTo(minRadius, n.startAngle, minRadius), n.Close()], {
         slicePathString: slicePathString
         , linePathString: ""
         , titlePosX: n.titlePosX
         , titlePosY: n.titlePosY
      ...
      endTheta = n.endTheta;
      var u, f;
      return n.sliceAngle < 120 ? (n.titleRadius = r * .57, u = .9, middleRadiusPercent = .87, f = .87) : n.sliceAngle < 180 ? (n.titleRadius = r * .52, u = .91, middleRadiusPercent = .87, f = .87) : (n.titleRadius = r * .45, u = .873, middleRadiusPercent = .87, f = .94), slicePathString = [n.MoveTo(n.middleAngle, r * .07), ["L", r * .07 * Math.cos(middleTheta) + r * f * Math.cos(startTheta) + x, r * .07 * Math.sin(middleTheta) + r * f * Math.sin(startTheta) + y], ["A", r * u, r * u, 0, 0, 1, r * .07 * Math.cos(middleTheta) + r * middleRadiusPercent * Math.cos(middleTheta) + x, r * .07 * Math.sin(middleTheta) + r * middleRadiusPercent * Math.sin(middleTheta) + y], ["A", r * u, r * u, 0, 0, 1, r * .07 * Math.cos(middleTheta) + r * f * Math.cos(endTheta) + x, r * .07 * Math.sin(middleTheta) + r * f * Math.sin(endTheta) + y], n.Close()], linePathString = [n.MoveTo(n.startAngle, r), n.ArcTo(r, n.middleAngle, r), n.ArcTo(r, n.endAngle, r), n.ArcBackTo(r, n.middleAngle, r), n.ArcBackTo(r, n.startAngle, r)], n.setTitlePos(), {
         slicePathString: slicePathString
         , linePathString: linePathString
         , titlePosX: n.titlePosX
         , titlePosY: n.titlePosY
      ...
      var i = n.wheelRadius * .9
         , r = 360 / n.sliceAngle
         , t = 2 * i / r;
      return x = n.centerX, y = n.centerY, itemIndex = n.itemIndex, titlePosX = x, titlePosY = itemIndex * t + y + t / 2 - i, slicePathString = [["M", x - t / 2, itemIndex * t + y - i], ["L", t / 2 + x, itemIndex * t + y - i], ["L", t / 2 + x, (itemIndex + 1) * t + y - i], ["L", x - t / 2, (itemIndex + 1) * t + y - i], ["z"]], {
         slicePathString: slicePathString
         , linePathString: ""
         , titlePosX: titlePosX
         , titlePosY: titlePosY
      ...
      return n.setBaseValue(t, i), r = n.sliceRadius, slicePathString = [n.MoveToCenter(), n.ArcTo(r / 2, n.startAngle, r), n.ArcTo(r, n.middleAngle, r), n.ArcTo(r, n.endAngle, r), n.ArcBackTo(r / 2, 0, 0), n.Close()], titlePosX = n.getX(n.startAngle, r / 2), titlePosY = n.getY(n.startAngle, r / 2), {
         slicePathString: slicePathString
         , linePathString: slicePathString
         , titlePosX: titlePosX
         , titlePosY: titlePosY
      ...
      return i === null && (i = TutorialSliceCustomization()), n.setBaseValue(t, i), slicePathString = [], slicePathString.push(n.MoveToCenter()), i.isMoveTo === !0 && slicePathString.push(n.MoveTo(n.middleAngle, n.sliceRadius / 4)), i.isLineTo && slicePathString.push(n.LineTo(n.startAngle, n.sliceRadius)), i.isArcTo && slicePathString.push(n.ArcTo(n.sliceRadius, n.middleAngle, n.sliceRadius)), i.isArcBackTo && slicePathString.push(n.ArcBackTo(n.sliceRadius, n.endAngle, n.sliceRadius)), slicePathString.push(n.Close()), linePathString = [n.MoveToCenter(), n.LineTo(n.startAngle, n.sliceRadius), n.ArcTo(n.sliceRadius, n.middleAngle, n.sliceRadius), n.ArcTo(n.sliceRadius, n.endAngle, n.sliceRadius), n.Close()], {
         slicePathString: slicePathString
         , linePathString: linePathString
         , titlePosX: n.titlePosX
         , titlePosY: n.titlePosY
...
markerPath = function () {
   return this.NullMarker = function (n, t) {
      ...
      var u = n.sliceRadius * i.arcBaseRadiusPercent
         ...
         , f = n.startAngle + n.sliceAngle * .46
         , e = n.startAngle + n.sliceAngle * .54;
      ...
      return t <= .05 && (r = 11), middleTheta = n.middleTheta, markerPathString = [["M", n.titlePosX - r * Math.cos(middleTheta), n.titlePosY - r * Math.sin(middleTheta)], ["A", r, r, 0, 0, 1, n.titlePosX + r * Math.cos(middleTheta), n.titlePosY + r * Math.sin(middleTheta)], ["A", r, r, 0, 0, 1, n.titlePosX - r * Math.cos(middleTheta), n.titlePosY - r * Math.sin(middleTheta)], ["z"]], {
         markerPathString: markerPathString
         , titlePosX: n.titlePosX
         , titlePosY: n.titlePosY
      }
